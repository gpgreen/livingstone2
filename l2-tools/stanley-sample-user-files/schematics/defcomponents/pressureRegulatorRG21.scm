global pirNodes
set pirNodes {83 1 2 4 6 8 10 12 14}
global pirNode
set pirNode(83) {edgesFrom {{}} edgesTo {{}} numArgsVars 0 argsValues {} attributes ?name.displayState port_terminals {} output_terminals ?name.pneumaticsLineOut input_terminals ?name.pneumaticsLineIn nodeInstanceName ?name nodeState nominal nodeStateBgColor gray90 nodeClassName pressureRegulatorRG21 numInputs 1 numOutputs 1 fgColor black nodeGroupName root parentNodeGroupList root nodeClassType component inputs {in1 {type {pneumaticsLinePressure in} terminal_name ?name.pneumaticsLineIn terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} outputs {out1 {type {pneumaticsLinePressure out} terminal_name ?name.pneumaticsLineOut terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} transitionModesToDraw {} displayStatePropName ?name.displayState instanceLabel {} nodeHasIconP 1 nodeX 100 nodeY 100 labelX 100 labelY 75 window .master.canvas.root.c.w2}

set pirNode(1) {nodeGroupName ?name edgesFrom {} edgesTo {} nodeInstanceName root_P4 nodeState parent-link nodeStateBgColor gray90 nodeClassName pressureRegulatorRG21 numInputs 0 numOutputs 0 fgColor black nodeClassType module inputs {} outputs {} parentNodeGroupList {?name root} nodeX 5 nodeY 5 labelX -1 labelY -1 window .master.canvas.?name.c.w5 nodeHasIconP 0}

set pirNode(2) {edgesFrom {} edgesTo {} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {} numInputs 0 model {{pneumaticsLineOut.rg21.upperBound = belowThreshold;
pneumaticsLineOut.rg21.lowerBound = pneumaticsLineIn.rg21.lowerBound;
pneumaticsLineOut.rg02.upperBound = belowThreshold;
pneumaticsLineOut.rg02.lowerBound = belowThreshold;}} nodeDescription {} nodeClassType mode nodeInstanceName ?name.nominal nodeState {} nodeStateBgColor lightgreen nodeClassName okMode fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 nodeX 230 nodeY 240 labelX 222 labelY 215 window .master.canvas.?name.c.w6}
...
set pirNode(8) {edgesFrom {} edgesTo {} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {} numInputs 0 probability likely model {{pneumaticsLineOut.rg21 = pneumaticsLineIn.rg21;
// no constraints possible w.r.t. rg02 bounds. unless we say how 'high';}} nodeDescription {} nodeClassType mode nodeInstanceName ?name.regulatingHigh nodeState {} nodeStateBgColor red1 nodeClassName faultMode fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 nodeX 380 nodeY 240 labelX 351 labelY 215 window .master.canvas.?name.c.w12}

set pirNode(10) {edgesFrom {} edgesTo {} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {} numInputs 0 probability likely model {{pneumaticsLineOut.rg21.upperBound = belowThreshold;
pneumaticsLineOut.rg21.lowerBound = belowThreshold;
pneumaticsLineOut.rg02.upperBound = belowThreshold;
...
set g_NM_livingstoneDefcomponentFileName {pressureRegulatorRG21}
global g_NM_livingstoneDefcomponentName
set g_NM_livingstoneDefcomponentName {pressureRegulatorRG21}

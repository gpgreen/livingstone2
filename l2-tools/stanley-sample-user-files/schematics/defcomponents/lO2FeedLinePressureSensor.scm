global pirNodes
set pirNodes {97 1 2 4 6 8 10}
global pirNode
set pirNode(97) {edgesFrom {{}} edgesTo {{}} numArgsVars 0 argsValues {} attributes ?name.displayState port_terminals {} output_terminals ?name.pressureReading input_terminals ?name.sensedPressure nodeInstanceName ?name nodeState nominal nodeStateBgColor gray90 nodeClassName lO2FeedLinePressureSensor numInputs 1 numOutputs 1 fgColor black nodeGroupName root parentNodeGroupList root nodeClassType component inputs {in1 {type {lO2FeedLinePressure in} terminal_name ?name.sensedPressure terminal_label {} commandMonitorType {monitored {unknown unknown}} interfaceType public}} outputs {out1 {type {lO2FeedLinePressure out} terminal_name ?name.pressureReading terminal_label {} commandMonitorType {monitored {unknown unknown}} interfaceType public}} transitionModesToDraw {} nodeHasIconP 1 displayStatePropName ?name.displayState instanceLabel {} nodeX 100 nodeY 100 labelX 98 labelY 75 window .master.canvas.root.c.w2}

set pirNode(1) {nodeGroupName ?name edgesFrom {} edgesTo {} nodeInstanceName root_P4 nodeState parent-link nodeStateBgColor gray90 nodeClassName lO2FeedLinePressureSensor numInputs 0 numOutputs 0 fgColor black nodeClassType module inputs {} outputs {} parentNodeGroupList {?name root} nodeX 5 nodeY 5 labelX -1 labelY -1 window .master.canvas.?name.c.w5 nodeHasIconP 0}

set pirNode(2) {edgesFrom {{}} edgesTo {} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {out1 {type {lO2FeedLinePressure out} terminal_name ?name.sensedPressure terminal_label {} commandMonitorType {monitored {unknown unknown}} interfaceType public}} numOutputs 1 inputs {} numInputs 0 nodeDescription {} nodeClassType terminal nodeInstanceName ?name.sensedPressure nodeState {} nodeStateBgColor gray90 nodeClassName input fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 inheritedCmdMonP 1 nodeX 230 nodeY 110 labelX 195 labelY 85 window .master.canvas.?name.c.w6}

set pirNode(4) {edgesFrom {} edgesTo {{}} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {in1 {type {lO2FeedLinePressure in} terminal_name ?name.pressureReading terminal_label {} commandMonitorType {monitored {unknown unknown}} interfaceType public}} numInputs 1 nodeDescription {} nodeClassType terminal nodeInstanceName ?name.pressureReading nodeState {} nodeStateBgColor gray90 nodeClassName output fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 inheritedCmdMonP 1 nodeX 230 nodeY 320 labelX 192 labelY 295 window .master.canvas.?name.c.w8}
...
global pirEdge
global pirClasses
set pirClasses {lO2FeedLinePressureSensor input output okMode faultMode displayState}
global pirClass
set pirClass(lO2FeedLinePressureSensor) {nodeClassType component inputs {} outputs {} class_variables {name_var {default ?name} args {default {}} argTypes {default {}} documentation {default {}} input_terminals {default {{lO2FeedLinePressure ?name.sensedPressure {}}}} output_terminals {default {{lO2FeedLinePressure ?name.pressureReading {}}}} port_terminals {default {}} attributes {default {{displayStateValues ?name.displayState {}}}} mode {default nominal} ok_modes {default nominal} fault_modes {default unknownFault} mode_transitions {default {}} background_model {default {}} background_documentation {default {}} initially {default {}} initial_mode {default nominal} recovery_modes {default {}}}}
...
set g_NM_livingstoneDefcomponentFileName {lO2FeedLinePressureSensor}
global g_NM_livingstoneDefcomponentName
set g_NM_livingstoneDefcomponentName {lO2FeedLinePressureSensor}

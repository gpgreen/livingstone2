global pirNodes
set pirNodes {58 1 2 4 6 8 10 12 14 16 18}
global pirNode
set pirNode(58) {edgesFrom {{}} edgesTo {{} {}} numArgsVars 0 argsValues {} attributes ?name.displayState port_terminals {} output_terminals ?name.pipeOut input_terminals {?name.pipeIn ?name.valveCmdIn} nodeInstanceName ?name nodeState open nodeStateBgColor gray90 nodeClassName nO2WaySolenoidValve numInputs 2 numOutputs 1 fgColor black nodeGroupName root parentNodeGroupList root nodeClassType component inputs {in1 {type {openCloseCommand in} terminal_name ?name.valveCmdIn terminal_label {} commandMonitorType {commanded noCommand} interfaceType public} in2 {type {pipe in} terminal_name ?name.pipeIn terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} outputs {out1 {type {pipe out} terminal_name ?name.pipeOut terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} transitionModesToDraw {} nodeHasIconP 1 displayStatePropName ?name.displayState instanceLabel {} nodeX 100 nodeY 100 labelX 105 labelY 75 window .master.canvas.root.c.w2}

set pirNode(1) {nodeGroupName ?name edgesFrom {} edgesTo {} nodeInstanceName root_P4 nodeState parent-link nodeStateBgColor gray90 nodeClassName nO2WaySolenoidValve numInputs 0 numOutputs 0 fgColor black nodeClassType module inputs {} outputs {} parentNodeGroupList {?name root} nodeX 5 nodeY 5 labelX -1 labelY -1 window .master.canvas.?name.c.w5 nodeHasIconP 0}
...
global pirEdge
global pirClasses
set pirClasses {nO2WaySolenoidValve displayState faultMode okMode input output}
global pirClass
set pirClass(nO2WaySolenoidValve) {nodeClassType component inputs {} outputs {} class_variables {name_var {default ?name} args {default {}} documentation {default {}} input_terminals {default {{openCloseCommand ?name.valveCmdIn {}} {pipe ?name.pipeIn {}}}} output_terminals {default {{pipe ?name.pipeOut {}}}} port_terminals {default {}} attributes {default {{displayStateValues ?name.displayState displayState}}} mode {default open} ok_modes {default {open closed}} fault_modes {default {stuckClosed stuckOpen unknownFault}} mode_transitions {default {{open closed} {closed open}}} background_model {default {}} background_documentation {default {}} initially {default {}} initial_mode {default open} recovery_modes {default {}} argTypes {default {}}}}
...
set g_NM_livingstoneDefcomponentFileName {nO2WaySolenoidValve}
global g_NM_livingstoneDefcomponentName
set g_NM_livingstoneDefcomponentName {nO2WaySolenoidValve}

global pirNodes
set pirNodes {112 1 2 4 6 8}
global pirNode
set pirNode(112) {edgesFrom {{}} edgesTo {} numArgsVars 0 argsValues {} attributes ?name.displayState port_terminals {} output_terminals ?name.pneumaticsLineOut input_terminals {} nodeInstanceName ?name nodeState nominal nodeStateBgColor gray90 nodeClassName gHeTank numInputs 0 numOutputs 1 fgColor black nodeGroupName root parentNodeGroupList root nodeClassType component inputs {} outputs {out1 {type {mpre107pSetPoints out} terminal_name ?name.pneumaticsLineOut terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} transitionModesToDraw {} nodeHasIconP 1 displayStatePropName ?name.displayState instanceLabel {} nodeX 100 nodeY 100 labelX 100 labelY 75 window .master.canvas.root.c.w2}

set pirNode(1) {nodeGroupName ?name edgesFrom {} edgesTo {} nodeInstanceName root_P4 nodeState parent-link nodeStateBgColor gray90 nodeClassName gHeTank numInputs 0 numOutputs 0 fgColor black nodeClassType module inputs {} outputs {} parentNodeGroupList {?name root} nodeX 5 nodeY 5 labelX -1 labelY -1 window .master.canvas.?name.c.w5 nodeHasIconP 0}

set pirNode(2) {edgesFrom {} edgesTo {} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {} numInputs 0 model {{pneumaticsLineOut.rg21.upperBound = aboveThreshold;
pneumaticsLineOut.rg21.lowerBound = aboveThreshold;
pneumaticsLineOut.rg02.upperBound = aboveThreshold;
pneumaticsLineOut.rg02.lowerBound = aboveThreshold;}} nodeDescription {} nodeClassType mode nodeInstanceName ?name.nominal nodeState {} nodeStateBgColor lightgreen nodeClassName okMode fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 nodeX 280 nodeY 140 labelX 272 labelY 115 window .master.canvas.?name.c.w6}

set pirNode(4) {edgesFrom {} edgesTo {{}} nodeGroupName ?name numArgsVars 0 argsValues {} outputs {} numOutputs 0 inputs {in1 {type {mpre107pSetPoints in} terminal_name ?name.pneumaticsLineOut terminal_label {} commandMonitorType {monitored {unknown unknown unknown unknown}} interfaceType public}} numInputs 1 nodeDescription {} nodeClassType terminal nodeInstanceName ?name.pneumaticsLineOut nodeState {} nodeStateBgColor gray90 nodeClassName output fgColor black instanceLabel {} parentNodeGroupList {?name root} nodeHasIconP 1 inheritedCmdMonP 1 nodeX 280 nodeY 220 labelX 236 labelY 195 window .master.canvas.?name.c.w8}
...
set g_NM_livingstoneDefcomponentFileName {gHeTank}
global g_NM_livingstoneDefcomponentName
set g_NM_livingstoneDefcomponentName {gHeTank}

global pirClasses
set pirClasses {tankPressure}
global pirClass
set pirClass(tankPressure) {nodeClassType structure class_variables {name_var {default {}} parentType {default <unspecified>} args {default {pr02Crack pressurizationRate boiloffRate bleedRate ventingRate}} argTypes {default {thresholdValues range range range range}} documentation {default {}} form {default {// the pressurizationRate range is above the boiloffRate range is above

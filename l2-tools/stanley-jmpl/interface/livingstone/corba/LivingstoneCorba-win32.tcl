...
{interface {IDL:LivingstoneCorba/LivingstoneEventListener:1.0\
LivingstoneEventListener 1.0}} {struct\
...
string} {time long}} {}} {struct\
{IDL:LivingstoneCorba/LivingstoneAssignmentReport:1.0\
LivingstoneAssignmentReport 1.0} {{assignments {sequence\
IDL:LivingstoneCorba/Assignment:1.0}}} {}} {exception\
{IDL:LivingstoneCorba/LivingstoneException:1.0 LivingstoneException 1.0} {{id\
long} {description string}} {}} {interface\
{IDL:LivingstoneCorba/LivingstoneEngineManager:1.0 LivingstoneEngineManager\
1.0} {} {{operation\
...
1.0} void {} {}}}} {interface\
{IDL:LivingstoneCorba/LivingstoneCommandLine:1.0 LivingstoneCommandLine 1.0}\
{} {{operation {IDL:LivingstoneCorba/LivingstoneCommandLine/command:1.0\
command 1.0} void {{in command string}} {}} {operation\
...
IDL:LivingstoneCorba/LivingstoneEventListener:1.0}}\
IDL:LivingstoneCorba/LivingstoneException:1.0}}} {interface\

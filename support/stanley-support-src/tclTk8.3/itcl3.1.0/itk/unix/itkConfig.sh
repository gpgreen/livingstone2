...
# build directory.
ITK_BUILD_LIB_SPEC='-L/home/wtaylor/L2Skunk/support/stanley-support-src/tclTk8.3/itcl3.1.0/itk/unix -litk3.1'

# String to pass to linker to pick up the Itk library from its
# installed directory.
ITK_LIB_SPEC='-L/home/wtaylor/L2Skunk/l2-tools/stanley-jmpl/support/tclTk8.3/lib -litk3.1'
...
# build directory.
ITK_BUILD_STUB_LIB_SPEC='-L/home/wtaylor/L2Skunk/support/stanley-support-src/tclTk8.3/itcl3.1.0/itk/unix -litkstub3.1'

# String to pass to linker to pick up the Itk stub library from its
# installed directory.
ITK_STUB_LIB_SPEC='-L/home/wtaylor/L2Skunk/l2-tools/stanley-jmpl/support/tclTk8.3/lib -litkstub3.1'
...
ITK_SRC_DIR='/home/wtaylor/L2Skunk/support/stanley-support-src/tclTk8.3/itcl3.1.0/itk'
